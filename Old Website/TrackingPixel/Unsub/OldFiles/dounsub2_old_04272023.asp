...
oConn.Open connStr
  ...
  SQL = "exec SP_PiXL_Unsub '" + firstname + "', '" + lastname + "', '" + address1 + "', '" + address2 + "', '" + city + "', '" + state + "', '" + zip + "', '" + email + "', '" + phone + "', '" + requesttype + "', '" + ipaddress + "', '" + source + "'"
  oConn.execute(SQL)
  response.redirect("https://smartpixl.com/Unsub/thankyou.html")
else
