-- ============================================================================
-- Migration 39: Fix usp_ParseNewHits BIGINT variable mismatch
-- ============================================================================
-- Migration 33 widened ETL.Watermark.LastProcessedId and PiXL.Raw.Id to BIGINT,
-- but the proc's local variables and temp table remained INT. This creates a
-- silent truncation risk once Id values exceed 2.1 billion.
--
-- Changes:
--   @LastId      INT → BIGINT
--   @MaxId       INT → BIGINT
--   @MaxParsedId INT → BIGINT
--   #BatchRows.SourceId INT → BIGINT
--
-- @Inserted, @DevicesUpserted, @IPsUpserted, @VisitsInserted stay INT
-- (row counts within a 10K batch will never overflow INT).
-- ============================================================================
PRINT '--- 39: Fixing usp_ParseNewHits BIGINT variable mismatch ---';
GO
...
PRINT '--- 39: usp_ParseNewHits BIGINT fix complete ---';
