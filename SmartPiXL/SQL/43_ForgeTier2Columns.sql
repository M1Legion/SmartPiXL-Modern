-- ============================================================================
-- Migration 43: Forge Tier 2 Enrichment Columns (Phase 5)
-- ============================================================================
-- Adds 10 new columns to PiXL.Parsed for Tier 2 enrichment data produced
-- by SmartPiXL Forge cross-request intelligence services:
--
--   Cross-customer: CrossCustomerHits, CrossCustomerAlert
--   Lead scoring:   LeadQualityScore
--   Session:        SessionId, SessionHitNumber, SessionDurationSec, SessionPageCount
--   Affluence:      AffluenceSignal, GpuTier
--
-- Updates ETL.usp_ParseNewHits:
--   New Phase 8C: Parses all _srv_* Tier 2 params via dbo.GetQueryParam()
-- ============================================================================
PRINT '--- 43: Adding Forge Tier 2 enrichment columns to PiXL.Parsed ---';
GO

-- =====================================================================
-- Step 1: Add columns — Cross-Customer Intelligence
-- =====================================================================
IF NOT EXISTS (
    SELECT 1 FROM sys.columns
    WHERE object_id = OBJECT_ID(N'PiXL.Parsed')
      AND name = N'CrossCustomerHits'
)
BEGIN
    ALTER TABLE PiXL.Parsed ADD CrossCustomerHits INT NULL;
    PRINT 'Added PiXL.Parsed.CrossCustomerHits (INT NULL)';
END
ELSE PRINT 'PiXL.Parsed.CrossCustomerHits already exists — skipped';
GO

IF NOT EXISTS (
    SELECT 1 FROM sys.columns
    WHERE object_id = OBJECT_ID(N'PiXL.Parsed')
      AND name = N'CrossCustomerAlert'
)
BEGIN
    ALTER TABLE PiXL.Parsed ADD CrossCustomerAlert BIT NULL;
    PRINT 'Added PiXL.Parsed.CrossCustomerAlert (BIT NULL)';
END
ELSE PRINT 'PiXL.Parsed.CrossCustomerAlert already exists — skipped';
GO

-- =====================================================================
-- Step 2: Add columns — Lead Quality Scoring
-- =====================================================================
IF NOT EXISTS (
    SELECT 1 FROM sys.columns
    WHERE object_id = OBJECT_ID(N'PiXL.Parsed')
      AND name = N'LeadQualityScore'
)
BEGIN
    ALTER TABLE PiXL.Parsed ADD LeadQualityScore INT NULL;
    PRINT 'Added PiXL.Parsed.LeadQualityScore (INT NULL)';
END
ELSE PRINT 'PiXL.Parsed.LeadQualityScore already exists — skipped';
GO

-- =====================================================================
-- Step 3: Add columns — Session Stitching
-- =====================================================================
IF NOT EXISTS (
    SELECT 1 FROM sys.columns
    WHERE object_id = OBJECT_ID(N'PiXL.Parsed')
...
BEGIN
    ALTER TABLE PiXL.Parsed ADD SessionId VARCHAR(36) NULL;
    PRINT 'Added PiXL.Parsed.SessionId (VARCHAR(36) NULL)';
END
ELSE PRINT 'PiXL.Parsed.SessionId already exists — skipped';
GO

IF NOT EXISTS (
    SELECT 1 FROM sys.columns
    WHERE object_id = OBJECT_ID(N'PiXL.Parsed')
      AND name = N'SessionHitNumber'
)
BEGIN
    ALTER TABLE PiXL.Parsed ADD SessionHitNumber INT NULL;
    PRINT 'Added PiXL.Parsed.SessionHitNumber (INT NULL)';
END
ELSE PRINT 'PiXL.Parsed.SessionHitNumber already exists — skipped';
GO

IF NOT EXISTS (
    SELECT 1 FROM sys.columns
    WHERE object_id = OBJECT_ID(N'PiXL.Parsed')
      AND name = N'SessionDurationSec'
)
BEGIN
    ALTER TABLE PiXL.Parsed ADD SessionDurationSec INT NULL;
    PRINT 'Added PiXL.Parsed.SessionDurationSec (INT NULL)';
END
ELSE PRINT 'PiXL.Parsed.SessionDurationSec already exists — skipped';
GO

IF NOT EXISTS (
    SELECT 1 FROM sys.columns
    WHERE object_id = OBJECT_ID(N'PiXL.Parsed')
      AND name = N'SessionPageCount'
)
BEGIN
    ALTER TABLE PiXL.Parsed ADD SessionPageCount INT NULL;
    PRINT 'Added PiXL.Parsed.SessionPageCount (INT NULL)';
END
ELSE PRINT 'PiXL.Parsed.SessionPageCount already exists — skipped';
GO

-- =====================================================================
-- Step 4: Add columns — Device Affluence
-- =====================================================================
IF NOT EXISTS (
    SELECT 1 FROM sys.columns
    WHERE object_id = OBJECT_ID(N'PiXL.Parsed')
      AND name = N'AffluenceSignal'
)
BEGIN
    ALTER TABLE PiXL.Parsed ADD AffluenceSignal VARCHAR(4) NULL;
    PRINT 'Added PiXL.Parsed.AffluenceSignal (VARCHAR(4) NULL)';
END
ELSE PRINT 'PiXL.Parsed.AffluenceSignal already exists — skipped';
GO
...
BEGIN
    ALTER TABLE PiXL.Parsed ADD GpuTier VARCHAR(4) NULL;
    PRINT 'Added PiXL.Parsed.GpuTier (VARCHAR(4) NULL)';
END
ELSE PRINT 'PiXL.Parsed.GpuTier already exists — skipped';
GO

-- =====================================================================
-- Step 5: Update ETL.usp_ParseNewHits — Add Phase 8C for Tier 2
...
-- 10 new Tier 2 enrichment fields. This is the authoritative copy
-- after migration 43.
-- =====================================================================
...
PRINT '--- 43: Forge Tier 2 enrichment columns migration complete ---';
