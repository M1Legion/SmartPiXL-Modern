...
BEGIN
    ...
    VALUES
        ...
        (3, 'Hits Today', NULL,
         ...
         'number', 1),
        (4, 'Last ETL Run', NULL,
         N'SELECT FORMAT(LastRunAt, ''HH:mm:ss'') FROM ETL.Watermark WHERE ProcessName = ''ProcessDimensions''',
         'text', 1),
        (4, 'ETL Watermark', NULL,
         N'SELECT FORMAT(LastProcessedId, ''N0'') FROM ETL.Watermark WHERE ProcessName = ''ProcessDimensions''',
         'number', 2),
