...
//
// Used by SelfHealingService and CompanyPiXLSyncService to notify the
// operator when remediation actions require manual approval, guards fire
// (missing tables), or the circuit breaker trips on a fatal error.
//
// CHANNELS:
