...
namespace SmartPiXL.Worker.Services;
...
//
// This client is used by InfraHealthService, SelfHealingService, and
// IpApiSyncService in the Worker to communicate with the Edge process
// without sharing in-memory state.
//
// RESILIENCE:
//   All calls swallow exceptions and return safe defaults. The Edge being
//   down should not crash the Worker — it just means health data is stale
